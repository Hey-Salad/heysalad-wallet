...
export type GetInternalTransactionsByAddressMetadataParam = FromSchema<typeof schemas.GetInternalTransactionsByAddress.metadata>;
export type GetInternalTransactionsByAddressResponse200 = FromSchema<typeof schemas.GetInternalTransactionsByAddress.response['200']>;
export type GetInternalTransactionsByAddressResponse400 = FromSchema<typeof schemas.GetInternalTransactionsByAddress.response['400']>;
export type GetInternalTransactionsByTransactionidMetadataParam = FromSchema<typeof schemas.GetInternalTransactionsByTransactionid.metadata>;
export type GetInternalTransactionsByTransactionidResponse200 = FromSchema<typeof schemas.GetInternalTransactionsByTransactionid.response['200']>;
export type GetInternalTransactionsByTransactionidResponse400 = FromSchema<typeof schemas.GetInternalTransactionsByTransactionid.response['400']>;
